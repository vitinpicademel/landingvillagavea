  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section id="oque" className="relative w-full flex flex-col items-center justify-center min-h-0 md:min-h-[900px] bg-white px-3 sm:px-4 pb-0 pt-8 sm:pt-16 -mt-0" style={{scrollMarginTop: '90px'}}>
          <div className="absolute top-0 left-0 w-full h-[180px] sm:h-[400px] md:h-[700px] bg-[#a10e0e] rounded-b-[32px] md:rounded-b-[80px] z-0"></div>
          ...
          <h2 className="relative z-10 text-2xl sm:text-2xl md:text-[64px] font-bold uppercase tracking-[-0.8px] text-white text-center mb-0 md:mb-10 leading-tight">
